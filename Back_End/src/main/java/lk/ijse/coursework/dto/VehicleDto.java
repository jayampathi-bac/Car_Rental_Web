...
public class VehicleDto {
    ...
    public VehicleDto(String id, String brand, String type, int passenger, String image, String transmission, String fuel, int milage, int priceperextrakm, int dailyrate, int freekmforday, int monthlyrate, int freekmformonth, int status) {
        this.id = id;
        this.brand = brand;
        this.type = type;
